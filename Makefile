...
# TEST_SOURCES =$(TEST_DIR)/system_test_Sensor_PLC_Receiver.cpp $(TEST_DIR)/system_test_Receiver_Sensor_PLC.cpp  $(TEST_DIR)/sensor_manager_test.cpp $(TEST_DIR)/plc_manager_test.cpp $(TEST_DIR)/data_receiver_test.cpp $(TEST_DIR)/main.cpp
TEST_SOURCES = $(TEST_DIR)/plc_manager_test.cpp $(TEST_DIR)/data_receiver_test.cpp $(TEST_DIR)/main.cpp
