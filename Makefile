...
SENSOR_SOURCES = $(SRC_DIR)/sensor.cpp $(SRC_DIR)/sensor_manager.cpp $(SRC_DIR)/logger.cpp $(SRC_DIR)/config_loader.cpp
PLC_SOURCES = $(SRC_DIR)/plc.cpp $(SRC_DIR)/plc_manager.cpp $(SRC_DIR)/logger.cpp $(SRC_DIR)/config_loader.cpp
